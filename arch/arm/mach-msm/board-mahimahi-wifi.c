...
static int __init mahimahi_wifi_init(void)
{
	...
	mahimahi_wifi_update_nvs("btc_params6=30\n");

	strip_nvs_param("pa0maxpwr");
	mahimahi_wifi_update_nvs("pa0maxpwr=78\n");

	strip_nvs_param("opo");
	mahimahi_wifi_update_nvs("opo=20\n");

	strip_nvs_param("mcs2gpo0");
	mahimahi_wifi_update_nvs("mcs2gpo0=0xCCCC\n");

	strip_nvs_param("mcs2gpo1");
	mahimahi_wifi_update_nvs("mcs2gpo1=0xCCCC\n");

	strip_nvs_param("rxpo2g");
	mahimahi_wifi_update_nvs("rxpo2g=0\n");
